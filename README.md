...
- [0-co/agent-friend](https://github.com/0-co/agent-friend) 🐍 - Schema quality grader for MCP tools. Validates, audits token costs, and assigns letter grades (A+ to F). CLI, GitHub Action, and web tools included.
